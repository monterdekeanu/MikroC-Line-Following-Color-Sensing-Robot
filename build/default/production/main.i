...
void controlMotorsSimplified() {
    ...
    if(center == 1 && left == 1 && right == 1){
        ...
        forward();
        terminalTracker++;
        _delay((unsigned long)((750)*(20000000/4000.0)));
        return;
    }
...
void TCS34725_Init(void) {
    I2C_Master_Start();
    I2C_Master_Write(0x29 << 1);
    I2C_Master_Write(0x80 | 0x00);
    I2C_Master_Write(0x03);
    I2C_Master_Stop();

    I2C_Master_Start();
    I2C_Master_Write(0x29 << 1);
    I2C_Master_Write(0x80 | 0x01);
    I2C_Master_Write(0xD5);
    I2C_Master_Stop();

    I2C_Master_Start();
    I2C_Master_Write(0x29 << 1);
    I2C_Master_Write(0x80 | 0x0F);
...
void TCS34725_ReadColors(uint16_t *red, uint16_t *green, uint16_t *blue) {
    ...
    I2C_Master_Start();
    I2C_Master_Write(0x29 << 1);
    I2C_Master_Write(0x80 | 0x20 | 0x16);
    I2C_Master_RepeatedStart();
    I2C_Master_Write((0x29 << 1) | 1);
    low = I2C_Read_Byte();
    I2C_ACK();
    high = I2C_Read_Byte();
    I2C_NACK();
    ...
    *red = (high << 8) | low;
    ...
    I2C_Master_Start();
    I2C_Master_Write(0x29 << 1);
    I2C_Master_Write(0x80 | 0x20 | 0x18);
    I2C_Master_RepeatedStart();
    I2C_Master_Write((0x29 << 1) | 1);
    low = I2C_Read_Byte();
    I2C_ACK();
    ...
    *green = (high << 8) | low;
    ...
    I2C_Master_Start();
    I2C_Master_Write(0x29 << 1);
    I2C_Master_Write(0x80 | 0x20 | 0x1A);
    I2C_Master_RepeatedStart();
    I2C_Master_Write((0x29 << 1) | 1);
    low = I2C_Read_Byte();
    I2C_ACK();
